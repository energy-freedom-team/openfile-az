...
- **A cursive typed electronic signature** on page 2 (or your PNG signature image if you prefer), valid under [A.R.S. § 44-7007](https://www.azleg.gov/ars/44/07007.htm).
...
# 5. File the signed PDFs with your committee's designated filing officer
#    (state SOS, county elections, city clerk — depends on your committee type).
```
...
No. It's an independent open-source project. It produces PDFs you file with whichever body your committee reports to (state, county, city, or clean-elections). It is not affiliated with or endorsed by the Arizona Secretary of State.

**Q: Where do I actually submit the generated PDF?**
That depends on your committee type and jurisdiction. Candidate committees for statewide and legislative offices typically file with the AZ Secretary of State; county, municipal, and special-district committees file with county or local elections officials. Check your committee registration to confirm. openfile-az intentionally does not link to a single "submit here" portal, because the right venue varies.
...
Yes. A.R.S. § 44-7007 provides for electronic signatures on filings. The typed cursive signature (default) and image overlay (optional) both meet that standard. If your committee's internal policy requires a handwritten signature, print the PDF and sign by hand — the form is still machine-generated and valid.
...
No. openfile-az produces the signed PDF and any Excel supplements. You still submit them yourself through whatever channel your filing officer accepts — a jurisdiction-specific online portal, an email attachment, or a physical filing.
